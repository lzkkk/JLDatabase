...
+ (id)populateObject:(id)obj fromResultSet:(FMResultSet *)set exclude:(NSArray *)excludeArray {
    ...
    Class cls = [obj class];
    NSDictionary* properties = [LIPFMDatabaseUtils propertiesForClass:cls];
...
+ (id)populateObject:(id)obj fromResultSet:(FMResultSet *)set {
    ...
    obj = [LIPFMDatabaseUtils populateObject:obj fromResultSet:set exclude:nil];
    return obj;
...
+ (id)objectWithClass:(Class)cls fromResultSet:(FMResultSet *)set {
    ...
    [LIPFMDatabaseUtils populateObject:obj fromResultSet:set];
    return obj;
