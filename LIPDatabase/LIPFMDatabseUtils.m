...
@implementation LIPFMDatabseUtils
...
+ (id)populateObject:(id)obj fromResultSet:(FMResultSet *)set exclude:(NSArray *)excludeArray {
    ...
    Class cls = [obj class];
    NSDictionary* properties = [LIPFMDatabseUtils propertiesForClass:cls];
...
+ (id)populateObject:(id)obj fromResultSet:(FMResultSet *)set {
    ...
    obj = [LIPFMDatabseUtils populateObject:obj fromResultSet:set exclude:nil];
    return obj;
...
+ (id)objectWithClass:(Class)cls fromResultSet:(FMResultSet *)set {
    ...
    [LIPFMDatabseUtils populateObject:obj fromResultSet:set];
    return obj;
