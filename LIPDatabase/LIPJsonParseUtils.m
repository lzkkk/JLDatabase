...
@implementation LIPJsonParseUtils
...
+(id)populateObject:(id)obj fromDictionary:(NSDictionary *)dict exclude:(NSArray *)excludeArray {
    ...
    Class cls = [obj class];
    NSDictionary* properties = [LIPJsonParseUtils propertiesForClass:cls];
    ...
    for (id key in dict) {
        ...
        if ([propertyType isEqualToString:@"NSString"] \
            ...
            if ([propertyType isEqualToString:@"NSString"] == NO &&
                ...
                [LIPJsonParseUtils populateObject:childObj fromDictionary:value exclude:nil];
                if ([key isEqualToString:@"id"]) {
...
+(id)populateObject:(id)obj fromDictionary:(NSDictionary *)dict {
    obj = [LIPJsonParseUtils populateObject:obj fromDictionary:dict exclude:nil];
...
+ (id)objectWithClass:(Class)cls fromDictionary:(NSDictionary *)dict {
    ...
    [LIPJsonParseUtils populateObject:obj fromDictionary:dict];
    return obj;
}

+ (NSMutableDictionary *)mutableDictionaryForObject:(id)obj {
    NSDictionary* propertyDict = [LIPJsonParseUtils propertiesForClass:[obj class]];
...
+(NSMutableDictionary *)mutableDictionaryForObject:(id)obj include:(NSArray *)includeArray {
    NSDictionary* dict = [LIPJsonParseUtils dictionaryForObject:obj include:includeArray];
    return [NSMutableDictionary dictionaryWithDictionary:dict];
}

+(NSDictionary*)dictionaryForObject:(id)obj {
    NSMutableDictionary *mutableDict = [LIPJsonParseUtils mutableDictionaryForObject:obj];
...
+(NSArray *)arrayOfClass:(Class)cls fromArray:(NSArray *)array {
    NSMutableArray *mutableArray = [LIPJsonParseUtils mutableArrayOfClass:cls fromArray:array];
...
+(NSMutableArray *)mutableArrayOfClass:(Class)cls fromArray:(NSArray *)array {
    ...
    for (id item in array) {
        ...
        id obj = [LIPJsonParseUtils objectWithClass:cls fromDictionary:item];
...
+(id)decodeObject:(Class)clazz from:(id)object{
    ...
    if (object && (clazz!=NULL)) {
        if(clazz == [NSDictionary class]||clazz == [NSArray class]){
            ...
            return [LIPJsonParseUtils objectWithClass:clazz fromDictionary:object];
